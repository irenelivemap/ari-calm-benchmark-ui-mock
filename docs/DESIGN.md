...
- The next medal's seal fills with light from the bottom in proportion to stage progress — the fill is the countdown, and it is never written as text. Exact numbers live on the medal's flip face and in its screen-reader label (`next goal, 5 of 10 routes`). When the fill reaches the top, the medal is earned and turns to its tier metal.
